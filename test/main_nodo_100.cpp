...
int main()
{
    ...
    avl_tree my_tree( "../misc/input/lista_100.txt" );

    ofstream fs( "../misc/output/max_and_min_100.txt" );
    ...
    ofstream fs2( "../misc/data/run_time_100.txt" );
    fs2 << "Execution Time 100 nodos: " << time << endl;
    fs2.close();
}
